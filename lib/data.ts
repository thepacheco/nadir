...
export const COMPANIES: Company[] = [
  ...
  },
  {
    ...
    alerts: [
      ...
      { sev: "WARNING", color: "#B47614", at: 0, time: "Sat", title: "Saturday OT run needs 6 certified kiln operators — only 4 scheduled", detail: "ADP training records joined against Saturday overtime approvals: two approved operators’ kiln certifications lapsed last month.", loc: "Training · scheduling", q: "Fix Saturday’s operator gap" },
